...
/**
 * This is the main class of Eclipse plugin
 * It is based on Eclipse view and displays Eclipse Logging View
 * View contains a clickable table of all unsent actions
 * 
 *  All Eclipse event listeners are registered here
 *  Actions sender thread is started from here
 *
 */
